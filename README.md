...
| 1    | Commit and Push Change from Command Line    | https://github.com/philippeloe/`repo-name`/commit/`commit-nr`                |
| 1    | Create a New Branch                         | https://github.com/philippeloe/`repo-name`/tree/`new-branch-name`            |
| 1    | Create a conda environment                  | https://github.com/philippeloe/`repo-name`/blob/`branch-name`/`env.yml`      |
